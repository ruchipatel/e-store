            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <div className="flex items-center mb-6">
                  <a
                    href="/#"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-primary hover:text-orange-900 sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={8}
                      height={16}
                  ...
                  <a
                    href="/#"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-primary hover:text-orangesm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={14}
                      height={14}
